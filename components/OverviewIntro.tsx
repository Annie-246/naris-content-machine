  ...
  <>
    <div className="rounded-3xl border border-slate-200 bg-gradient-to-br from-slate-50 to-white p-5 sm:p-8">
      <p className="text-[15px] sm:text-[17px] text-slate-700 leading-relaxed max-w-3xl">
        Nơi làm nội dung cho các thương hiệu Naris. App đọc những nội dung đang chạy tốt ngoài kia -
        video, bài đăng, bình luận của người xem - rồi dựng lại thành kịch bản và bài viết mang đúng
        giọng, đúng bản sắc của thương hiệu bạn đang chọn, bám sát danh mục sản phẩm đã khai báo chứ
        không nói chung chung. Tất cả để phục vụ một việc:{' '}
        <span className="font-semibold text-slate-900">tăng tốc độ sản xuất nội dung lên gấp 5 lần</span>.
      </p>

      <button
        onClick={onOpenBrand}
        className="mt-5 inline-flex items-center gap-2.5 text-sm font-semibold text-slate-700 hover:text-[#DB2777] transition-colors"
      >
